...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/ai0)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/ai0
```

A live public deployment of this template is available at [https://ai0.templates.workers.dev](https://ai0.templates.workers.dev)
